      ...
      <div className="w-full max-w-[1366px] flex justify-center">
        <div className="w-[73.5%]">
          <div
            className={
              isRegisterPage
                ? "w-[464px] bg-white rounded-[10px] border-t-[4px] border-solid border-t-[#1ABEC8] pt-[30px] px-[35px] pb-[12px] mt-[60px]"
                : "w-[464px] bg-white rounded-[10px] border-t-[4px] border-solid border-t-[#1ABEC8] pt-[30px] px-[35px] pb-[12px] mt-[80px]"
            }
          >
            <h1 className="text-[20px] mb-[10px] text-[#212529] font-['customFontExtraBold']">
            ...
            <p className="text-[12px] mb-[30px] font-['customFontMedium']">
              {isRegisterPage
            ...
            <form>
              <div className="w-full h-[61px] border border-solid border-[#D3D3D3] rounded-[15px] px-[15px]">
                ...
                <input
                  ...
                  name="Email"
                  id="Email"
                  className="w-full text-[13px] text-[#212529] border-none outline-none mt-[7px] font-['customFontSemiBold']"
                />
              </div>
              <div className="w-full h-[61px] border border-solid border-[#D3D3D3] rounded-[15px] px-[15px] flex justify-between items-center mt-[17px]">
                <div className="w-full h-full">
                  ...
                  <input
                    ...
                    name="Password"
                    id="Password"
                    className="w-full text-[13px] text-[#212529] border-none outline-none mt-[7px] font-['customFontMedium']"
                  />
                </div>
                <Image
            ...
            {isRegisterPage ? (
              <div className="text-[12px] text-[#7A7C7F] inline-block mt-[11px] mb-[20px]">
                Password must be at least 8 characters.
              </div>
            ) : (
              <div className="text-[12px] inline-block cursor-pointer my-[12px] tracking-[0.2px]">
                Reset Password
              </div>
            )}
            {isRegisterPage && (
              <div>
                ...
                >
                  ...
                  <p className="text-[14px] cursor-default ml-[5px]">
            ...
            <div className="flex flex-col">
              <button className="w-full h-[44px] bg-[#1ABEC8] text-white text-[14px] border-none rounded-[11px] mb-[10px] tracking-[0.2px]">
                {isRegisterPage ? "Register" : "Login"} with Steady Flights
              </button>
              <button className="w-full h-[44px] bg-white text-[14px] border-none rounded-[11px] flex justify-center items-center text-[#0000008A] shadow-[0px_2px_3px_0px_#0000002B] mb-[20px]">
                <Image
            ...
            <p className="text-[12px] tracking-[0.2px]">
